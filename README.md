...
* [1.1 Аннотированный список печатных источников по Философским проблемам информатики](#1.1_Аннотированный_список)
* [1.2 Интеллект-карта](#1.2_Интеллект-карта)
